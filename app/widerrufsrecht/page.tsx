    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-5xl px-6 py-14">
        <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-8 md:p-10">
          ...
          <p className="mt-4 text-slate-300">Gilt für Verbraucherinnen und Verbraucher im Sinne des § 13 BGB.</p>
          ...
          <div className="mt-10 space-y-6">
            <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6">
              ...
              <p className="mt-3 text-slate-300">
                ...
                <a href="mailto:info@vitaltwin.de" className="text-cyan-300 hover:underline">info@vitaltwin.de</a>
              </p>
              <p className="mt-3 text-slate-300">
            ...
            <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6">
              ...
              <div className="mt-4 rounded-xl border border-slate-700 bg-slate-950/70 p-5 font-mono text-sm text-slate-300">
